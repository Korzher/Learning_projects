...
const file_auth_proto_rawDesc = "" +
	...
	"\x16GoogleCallbackResponse\x12\x14\n" +
	...
	"\vGoogleLogin\x12\x18.auth.GoogleLoginRequest\x1a\x19.auth.GoogleLoginResponse\x12K\n" +
	"\x0eGoogleCallback\x12\x1b.auth.GoogleCallbackRequest\x1a\x1c.auth.GoogleCallbackResponseB\vZ\t./gen;genb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*GoogleLoginRequest)(nil),     // 10: auth.GoogleLoginRequest
	(*GoogleLoginResponse)(nil),    // 11: auth.GoogleLoginResponse
	(*GoogleCallbackRequest)(nil),  // 12: auth.GoogleCallbackRequest
	(*GoogleCallbackResponse)(nil), // 13: auth.GoogleCallbackResponse
}
var file_auth_proto_depIdxs = []int32{
	...
	10, // 5: auth.AuthService.GoogleLogin:input_type -> auth.GoogleLoginRequest
	12, // 6: auth.AuthService.GoogleCallback:input_type -> auth.GoogleCallbackRequest
	1,  // 7: auth.AuthService.CreateUser:output_type -> auth.CreateUserResponse
	3,  // 8: auth.AuthService.Authenticate:output_type -> auth.AuthenticateResponse
	5,  // 9: auth.AuthService.VerifyToken:output_type -> auth.VerifyTokenResponse
	7,  // 10: auth.AuthService.ChangePassword:output_type -> auth.ChangePasswordResponse
	9,  // 11: auth.AuthService.ResetPassword:output_type -> auth.ResetPasswordResponse
	11, // 12: auth.AuthService.GoogleLogin:output_type -> auth.GoogleLoginResponse
	13, // 13: auth.AuthService.GoogleCallback:output_type -> auth.GoogleCallbackResponse
