...
```
sudo docker ps -q | xargs -r sudo docker inspect --format '{{.State.Pid}}' | xargs -r sudo kill -9
```

Инициализация swagger
```
swag init -g app/cmd/ApiFromSpec/main.go --parseInternal --parseDependency
```
