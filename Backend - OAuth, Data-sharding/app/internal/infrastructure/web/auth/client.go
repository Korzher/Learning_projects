...
func (c *Client) GoogleLogin(ctx context.Context) (string, error) {
	resp, err := c.client.GoogleLogin(ctx, &pb.GoogleLoginRequest{})
	if err != nil {
		return "", err
	}
...
func (c *Client) GoogleCallback(ctx context.Context, code, state string) (string, error) {
	resp, err := c.client.GoogleCallback(ctx, &pb.GoogleCallbackRequest{
		Code:  code,
		State: state,
	})
	if err != nil {
